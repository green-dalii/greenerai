...
export const en: Dict = {
  ...
  practice: {
    ...
    cards: [
      ...
      },
      {
        ...
        title: 'Shift-Router',
        subtag: 'for Pi',
        body: 'A two-tier router for the Pi coding agent — cheap models for everyday turns, frontier models when it matters, with automatic failover and an LLM judge that knows when to upgrade.',
        stats: [
          { value: '1,235', label: 'downloads / mo', countTo: 1235 },
          { value: '0', label: 'runtime deps', countTo: 0 },
          { value: 'Pi', label: 'harness' },
        ],
      ...
      },
      {
        ...
        body: 'The same two-tier design adapted for DeepSeek Harness — task-level orchestration, instant upgrades, sliding-window downgrades, and cache-aware routing on the DeepSeek provider.',
        stats: [
          { value: '62', label: 'tests passing', countTo: 62 },
          { value: '0', label: 'runtime deps', countTo: 0 },
          { value: 'DSH', label: 'harness' },
        ],
  ...
  open: {
    ...
    cta2: 'Shift-Router on shiftrouter.greenerai.top',
