...
export const zh: Dict = {
  ...
  practice: {
    ...
    cards: [
      ...
      },
      {
        ...
        title: 'Shift-Router',
        subtag: '为 Pi Agent',
        body: '为 Pi 编码 Agent 设计的两层路由——日常轮次走便宜模型，关键时刻一键上强模型；带 LLM Judge 判断何时升级，运行时自动失败转移。',
        stats: [
      ...
      },
      {
        ...
        subtag: '为 DeepSeek Harness',
        body: '同一套两层路由设计，为 DeepSeek Harness 量身改写——任务级编排、一键升级、滑窗降级、缓存感知路由。',
        stats: [
          { value: '62', label: '测试通过', countTo: 62 },
          { value: '0', label: '运行时依赖', countTo: 0 },
  ...
  open: {
    ...
    cta2: '访问 shiftrouter.greenerai.top',
